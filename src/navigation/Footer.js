      ...
      <footer className="footer page-footer">
        <div className="container">
          ...
          <div>
            ...
            <a className="page-links"
               href="https://unsplash.com/@mhdr_m?utm_medium=referral&amp;utm_campaign=photographer-credit&amp;utm_content=creditBadge"
               target="_blank" rel="noopener noreferrer"
               title="Download free do whatever you want high-resolution photos from Mahdiar Mahmoodi">
              Mahdiar Mahmoodi
            </a>
