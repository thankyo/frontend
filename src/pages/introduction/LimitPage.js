...
function LimitPage({ limit, decrease, increase, fill = "#FFFFFF" }) {
  ...
  return (
    <div>
      ...
      <div>
        ...
        <p className="limit-text subtitle is-6">we'll <b className="is-danger">never</b> charge you more, than that
        </p>
      </div>
    </div>
  );
