    ...
    <div>
        ...
        <div className="container">
          <div className="content">
            <p>
              ...
              https://clemble.com website (the "Service") operated by Thank Project ("us", "we", or "our").
              ...
              part of the terms then you may not access the Service. [Our Terms of
              Service](https://termsfeed.com/blog/sample-terms-and-conditions-template/) was created with
              TermsFeed.
            </p>
            <p>
        ...
        <div className="container">
          ...
          <div className="content">
            <p>
              ...
              controlled by Thank Project.
              Thank Project has no control over, and assumes no responsibility for, the content, privacy
              policies, or practices of any third party web sites or services. You further acknowledge and
              agree that Thank Project shall not be responsible or liable, directly or indirectly, for any
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="content">
            <p>
              These Terms shall be governed and construed in accordance with the laws of Hong Kong, without
